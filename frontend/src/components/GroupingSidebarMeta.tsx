...
import { ChevronRight, ChevronDown, ArrowUp, ArrowDown, Eye, EyeOff, Check, Megaphone, Network, Maximize2 } from "lucide-react";
import type { Creative } from "@/lib/api";
import { type Dim, DIM_META, ALL_DIMS, HIERARCHY_PRESETS } from "@/lib/hierarchy.meta";
...
export function GroupingSidebarMeta({ creatives, hierarchy, setHierarchy, activeKey, setActive, rowHeight, setRowHeight }: Props) {
