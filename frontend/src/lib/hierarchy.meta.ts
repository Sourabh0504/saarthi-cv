...
// Meta's dimensions mirror the Google ones in shape, but Meta has no
// age_group/category feed data and does not surface "creative" as an
// explicit hierarchy dim in the reference project — creatives are always
// the implicit leaf level below the last configured dim.
...
export const DIM_META: Record<Dim, {
  ...
  adgroup:  { label: "Ad Set",    short: "AS",   get: c => c.ad_group,      icon: Boxes },
};
